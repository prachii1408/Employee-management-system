...
const Edit = (props) => {
    ...
    useEffect(()=>{
      axios.get(`https://api.thomso.in/apiV1/assignment/${props.id}`).then((res)=>{
    ...
    function handleSubmit(e){
        ...
        axios.put(`https://api.thomso.in/apiV1/assignment/${props.id}`,config).then(()=>props.userDisplay()).catch((error)=>
